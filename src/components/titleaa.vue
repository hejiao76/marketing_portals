<template>
  <div class="news">
    <div class="t_news">
      ...
      <ul class="swap"><li v-for="item in titlelist">{{item.username}}刚刚抽中了<span>{{levelType[item.level]}}</span>，快来试试你的运气</li></ul>
    </div>
  </div>
</template>
...
<style>
  ...
  .news_li li,.swap li { color: #ffffff !important; font-size: .1rem; width: 100%; text-align: center;}
  .news .swap {
    top:.23rem;
  }
</style>
