<template>
      ...
      <div class="checkedbox">
        <div class="boxtop">
            <div class="itemlist">
              <div class="input_box"  @click="activeed=!activeed"><span class="text">{{provinceName}}</span><i class="iconfont icon-jiantou"></i></div>
              <ul :class="['dowmlist',{active:activeed}]">
                <li  v-for="(item,index,key) in alllist" @click="provinceclick(item)">{{item.provinceName}}</li>
              </ul>
            </div>
          <div class="itemlist">
            <div class="input_box"  @click="citylist.length>0?activeeda=!activeeda:null"><span class="text">{{cityName}}</span><i class="iconfont icon-jiantou"></i></div>
