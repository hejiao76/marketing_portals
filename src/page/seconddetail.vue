<template>
      ...
      <div class="detailbox">
        <div class="detailTop">
          ...
          <div class="typebb" v-if="orderstatus==0">距秒杀开始还有<countdown :endTime="detailmesg.beginTime" :callback="callback" endText="00:00:00"></countdown></div>
        ...
        <div class="detail_list">
          ...
          <div class="list_item">
            ...
            <div class="item_list"  v-if="orderstatus==4">
              ...
              <span class="spb">{{detailmesg.verifyCode}}<span class="showcode" @click="codeimgshow=true"><span class="iconfont icon-erweima" style="margin-right: .05rem;"></span>查看核销码</span></span>
            </div>
          </div>
          <div class="list_item">
            <div class="item_list">
